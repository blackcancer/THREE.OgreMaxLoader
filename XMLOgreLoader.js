/*
	...
	FileVersion: 0.1-rev00001					Date: 2014-10-17
	By Blackcancer
...
THREE.MaterialLoader.prototype.parseMaterials	= function(txt, basePath){
	...
	for(key in params){
		...
		if(StarOS.GL.MeshPhongGlowMaterial){
			materials[key] = new StarOS.GL.MeshPhongGlowMaterial();
		}
		else {
		...
		if(params[key].ambient){
			...
			if(StarOS.GL.MeshPhongGlowMaterial){
				materials[id].uniforms.ambient.value = new THREE.Color(params[key].ambient[0], params[key].ambient[1], params[key].ambient[2]);
			}
			else {
				materials[id].ambient = new THREE.Color(params[key].ambient[0], params[key].ambient[1], params[key].ambient[2]);
			}
		}
		...
		if(params[key].specular){
			...
			if(StarOS.GL.MeshPhongGlowMaterial){
				materials[id].uniforms.specular.value = new THREE.Color(params[key].specular[0], params[key].specular[1], params[key].specular[2]);
			}
			else {
				materials[id].specular = new THREE.Color(params[key].specular[0], params[key].specular[1], params[key].specular[2]);
			}
		}
		...
		if(params[key].emissive){
			...
			if(StarOS.GL.MeshPhongGlowMaterial){
				materials[id].uniforms.emissive.value = new THREE.Color(params[key].emissive[0], params[key].emissive[1], params[key].emissive[2]);
			}
			else {
				materials[id].emissive = new THREE.Color(params[key].emissive[0], params[key].emissive[1], params[key].emissive[2]);
			}
		}
